...
define HEXAGONRPC_INSTALL_INIT_SYSV
	$(INSTALL) -D -m 744 $(BR2_EXTERNAL_CITRONICS_PATH)/package/hexagonrpc/S28hexagonfs \
		$(TARGET_DIR)/etc/init.d/S28hexagonfs
	$(INSTALL) -D -m 744 $(BR2_EXTERNAL_CITRONICS_PATH)/package/hexagonrpc/S32hexagonrpcd \
